...
class Domain5Reporting(BaseDomain):
    """Domain implementation using the shared BaseDomain interface."""

    key = "domain_5_reporting"
    title = "Domain 5: Risk of Bias – Selection of the Reported Result"
    questions = {
    ...
    # --------------------------------------------
    def evaluate(self, q5_1, q5_2, q5_3):
        """
...
_DOMAIN5 = Domain5Reporting()


# Compatibility helpers
def get_next_question_domain5(state: dict):
    return _DOMAIN5.get_next_question(state)


def rob2_domain5(q5_1, q5_2, q5_3):
    return _DOMAIN5.evaluate(q5_1, q5_2, q5_3)


QUESTIONS = Domain5Reporting.questions
