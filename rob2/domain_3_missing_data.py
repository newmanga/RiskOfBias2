...
class Domain3MissingData(BaseDomain):
    """Domain implementation using the shared BaseDomain interface."""

    key = "domain_3_missing_data"
    title = "Domain 3: Risk of Bias – Missing Outcome Data"
    questions = {
    ...
    # --------------------------------------------
    def evaluate(self, q3_1, q3_2, q3_3, q3_4):
        """
...
_DOMAIN3 = Domain3MissingData()


# Compatibility helpers
def get_next_question_domain3(state: dict):
    return _DOMAIN3.get_next_question(state)


def rob2_domain3(q3_1, q3_2, q3_3, q3_4):
    return _DOMAIN3.evaluate(q3_1, q3_2, q3_3, q3_4)


QUESTIONS = Domain3MissingData.questions
